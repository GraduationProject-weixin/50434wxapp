...
# 50434wxapp校园疫情防控管理平台小程序

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1NvtMeFEiw?p=94)


# 第1章 绪论
## 1.1 课题背景
互联网发展至今，无论是其理论还是技术都已经成熟，而且它广泛参与在社会中的方方面面。它让信息都可以通过网络传播，搭配信息管理工具可以很好地为人们提供服务。所以各行业，尤其是规模较大的企业和学校等都开始借助互联网和软件工具管理信息，传播信息，共享信息等等，以此可以增强自身实力，提高在同行业当中的竞争能力，并从各种激烈的竞争中获取发展的机会。针对高校教师成果信息管理混乱，出错率高，信息安全性差，劳动强度大，费时费力等问题，经过分析和考虑，在目前的情况下，可以引进一款校园疫情防控管理平台这样的现代化管理工具，这个工具就是解决上述问题的最好的解决方案。它不仅可以实时完成信息处理，还缩短高校教师成果信息管理流程，使其系统化和规范化。同时还可以减少工作量，节约高校教师成果信息管理需要的人力和资金。所以校园疫情防控管理平台是信息管理环节中不可缺少的工具，它对管理者来说非常重要。
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对高校教师成果信息管理，采用校园疫情防控管理平台可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用校园疫情防控管理平台，其意义如下：

第一点：校园疫情防控管理平台的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对校园疫情防控管理平台设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对校园疫情防控管理平台进行介绍时，将按照如下内容进行。

第一部分：介绍校园疫情防控管理平台研究的背景意义，便于用户了解系统；

第二部分：介绍开发校园疫情防控管理平台需要搭建的环境，包括技术和工具；

第三部分：介绍用户对校园疫情防控管理平台的功能要求，以及对校园疫情防控管理平台的性能要求等；
...
# 第2章 开发环境与技术
校园疫情防控管理平台的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对校园疫情防控管理平台用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，校园疫情防控管理平台开发可行。
### 3.1.3 操作可行性
校园疫情防控管理平台根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作校园疫情防控管理平台。
...
|3|fudaoyuan\_id|Integer|辅导员|是|
|4|yonghu\_id|Integer|防疫人员|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|fudaoyuan\_name|String|辅导员名称|是|
|3|fudaoyuan\_phone|String|辅导员手机号|是|
|4|fudaoyuan\_id\_number|String|辅导员身份证号|是|
|5|fudaoyuan\_photo|String|辅导员头像|是|
|6|fudaoyuan\_email|String|辅导员邮箱|是|
|7|fudaoyuan\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|yonghu\_id|Integer|防疫人员|是|
|3|guanliliuy\_name|String|姓名|是|
|4|sex\_types|Integer|性别|是|
|5|guanliliuy\_types|Integer|身份|是|
|6|yuanxi\_types|Integer|院系|是|
|7|guanliliuy\_tiwen|BigDecimal|当天体温|是|
|8|keshou\_types|Integer|有无咳嗽|是|
|9|wuaichu\_types|Integer|有无外出|是|
|10|guanliliuy\_didian|String|外出地点|是|
|11|binghuan\_types|Integer|是否接触病患|是|
|12|gaofengxian\_types|Integer|是否出入高风险区域|是|
|13|guanliliuy\_content|String|健康情况详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|meirixinxi\_name|String|信息标题|是|
|3|meirixinxi\_types|Integer|信息类型|是|
|4|meirixinxi\_photo|String|信息图片|是|
|5|insert\_time|Date|添加时间|是|
|6|meirixinxi\_content|String|信息详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|yonghu\_name|String|防疫人员名称|是|
|3|yonghu\_phone|String|防疫人员手机号|是|
|4|yonghu\_id\_number|String|防疫人员身份证号|是|
|5|yonghu\_photo|String|防疫人员头像|是|
|6|yonghu\_email|String|防疫人员邮箱|是|
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\辅导员.jpg](/md/blog.007.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\辅导员.jpg")
辅导员实体属性图

（3）下图是公告资讯实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\公告资讯.jpg](/md/blog.008.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\公告资讯.jpg")
公告资讯实体属性图

（4）下图是师生健康实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\师生健康.jpg](/md/blog.009.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\师生健康.jpg")
师生健康实体属性图

（5）下图是每日信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\每日信息.jpg](/md/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\每日信息.jpg")
每日信息实体属性图

（6）下图是防疫人员实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\防疫人员.jpg](/md/blog.011.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\防疫人员.jpg")
防疫人员实体属性图
# 第5章 系统实现
进入到这个环节，也就可以及时检查出前面设计的需求是否可靠了。一个设计良好的方案在运用于系统实现中，是会帮助系统编制人员节省时间，并提升开发效率的。所以在系统的编程阶段，也就是系统实现阶段，对于一些不合理的设计需求，也是可以及时发现。因为设计的方案是完全指导系统的编码过程的。
### 5.1防疫人员管理
如图5.1显示的就是防疫人员管理页面，此页面提供给管理员的功能有：防疫人员的查询管理，可以删除防疫人员、修改防疫人员、新增防疫人员，
...
图5.1 防疫人员管理页面
### 5.2 师生健康管理
如图5.2显示的就是师生健康管理页面，此页面提供给管理员的功能有：查看已发布的师生健康数据，修改师生健康，师生健康作废，即可删除，还进行了对师生健康名称的模糊查询 师生健康信息的类型查询等等一些条件。
...
图5.2 师生健康管理页面
### 5.3公告资讯管理
如图5.3显示的就是公告资讯管理页面，此页面提供给管理员的功能有：根据公告资讯进行条件查询，还可以对公告资讯进行新增、修改、查询操作等等。
